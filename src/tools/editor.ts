...
export const editorTool: ToolDef = categoryTool(
  ...
  undefined,
  {
    ...
    pieInstance: z.number().int().nonnegative().optional().describe("invoke_function: select this PIE client index when world='pie'"),
    worldPath: z.string().optional().describe("invoke_function: select an exact PIE world path when world='pie'; use the worldPath returned by a PIE query"),
